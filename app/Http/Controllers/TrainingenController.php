    ...
    public function update($id)
    {
        $validated = request()->validate(
            ...
            [
                ...
                'start.required' => 'Een starttijd is verplicht!',
                'start.string' => 'De starttijd is onjuist!',
                'start.max' => 'De starttijd is te lang!',
                'end.required' => 'Een eindtijd is verplicht!',
                'end.string' => 'De eindtijd is onjuist!',
                'end.max' => 'De eindtijd is te lang!',
