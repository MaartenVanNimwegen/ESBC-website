        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="fs-5">Lijkt basketbal je leuk? Kom dan eens langs op een van onze trainingen. Je mag <b>3 keer gratis
                            meedoen</b>
                        om te kijken of je basketbal een leuke sport vindt.</p>

                    <h2 class="fw-bold">Lidmaatschap</h2>
                    <p class="fs-5">Lijkt het je leuk om te gaan basketballen of heb je al een aantal keren meegedaan en wil je graag
                        lid
                    ...
                    <p class="fs-5">Je kunt je online aanmelden als lid van de basketbalvereniging ESBC Menhir door naar het
                    ...
                    <p class="fs-5">In het huishoudelijke reglement kun je alles lezen wat je moet weten als je lid bent van/wilt
                        worden
